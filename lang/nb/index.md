---
title: Semantisk versjonshåndtering 2.0.0
language: nb
author: Lars Simonsen
---

Semantisk versjonshåndtering 2.0.0
==============================

Sammendrag
-------

Gitt et versjonsnummer på formen MAJOR.MINOR.PATCH, øk:

1. MAJOR med 1 når du gjør endringer som påvirker bakoverkompatibiliteten for API,
2. MINOR med 1 når du legger til ny funksjonalitet men beholder 100 % bakoverkompatibilitet,
3. PATCH med 1 når du retter feil, forutsatt at 100 % bakoverkompatibilitet beholdes.

Du kan også gi versjonsnummeret et påheng for å markere f.eks. en test- eller betaversjon.

Introduksjon
------------

I programvareutviklingens verden finnes det et utrivelig sted som kalles "dependency hell", 
på norsk kan vi kort og godt kalle det "versjonshelvetet".
Jo større systemet ditt vokser seg, og jo flere pakker du integrerer, 
desto mer sannsynlig blir det at du en dag havner i denne avgrunnen.

I systemer med mange avhengigheter kan nye versjoner av pakker fort bli et mareritt. 
Hvis avhengighetsspesifikasjonene er for stramme, står du i fare for versjonslås 
(at du ikke kan oppgradere en pakke uten å samtidig gi ut en ny versjon av alle avhengige pakker).
Hvis spesifikasjonene er for løse, vil du støte på versjonsnaivitet (overtro på kompatibilitet med nyere versjoner).
